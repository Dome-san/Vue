...
describe('Router', () => {
  ...
  test('render Features when visiting /features', async () => {
  ...
  test('render Pricing when visiting /pricing', async () => {
  ...
  test('render Contact when visiting /contact', async () => {
  ...
  test('render LoginPage when visiting /pokemon/:id with no authentication', async () => {
    localStorage.clear();
  ...
  test('render PokemonPage when visiting /pokemon/:id with authentication', async () => {
